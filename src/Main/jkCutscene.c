...
int jkCutscene_sub_421310(char* fpath)
{
    ...
    if (!jkCutscene_pSmush)
    {
        jkCutscene_bSmkValid = 0;
        /*
         * On the Pyra, keep Smacker data in memory.
         * The PowerVR/SDL startup path can invalidate the file descriptor
         * of the very first intro when libsmacker stays in SMK_MODE_DISK.
         * SMK_MODE_MEMORY reads all frame chunks up front and closes the
         * FILE* immediately, avoiding later fseek(..., EBADF) failures.
         */
