...
void sithControl_MapDefaults()
{
    ...
    sithControl_DefaultHelper(INPUT_FUNC_TURN, DIK_A, 2);
    sithControl_DefaultHelper(INPUT_FUNC_TURN, DIK_D, 6);
   ...
   if (Main_bMotsCompat) {
        sithControl_MapFunc(INPUT_FUNC_SLIDE, DIK_LEFT, 0);
        sithControl_MapFunc(INPUT_FUNC_SLIDE, DIK_RIGHT, 4);
    }
    else {
        sithControl_MapFunc(INPUT_FUNC_SLIDE, DIK_LEFT, 4);
        sithControl_MapFunc(INPUT_FUNC_SLIDE, DIK_RIGHT, 0);
    }
    
    sithControl_MapFunc(INPUT_FUNC_JUMP, DIK_NEXT, 0);
    sithControl_MapFunc(INPUT_FUNC_DUCK, DIK_END, 0);
    sithControl_MapFunc(INPUT_FUNC_FIRE1, DIK_RCONTROL, 0);
    sithControl_MapFunc(INPUT_FUNC_ACTIVATE, DIK_HOME, 0);
    sithControl_MapFunc(INPUT_FUNC_FIRE2, DIK_RSHIFT, 0);
    sithControl_MapFunc(INPUT_FUNC_SLIDETOGGLE, DIK_T, 0);
    sithControl_MapFunc(INPUT_FUNC_SLOW, DIK_CAPITAL, 0);
    sithControl_MapFunc(INPUT_FUNC_FAST, DIK_RMENU, 0);
    sithControl_MapFunc(INPUT_FUNC_PITCH, DIK_Q, 0);
    sithControl_MapFunc(INPUT_FUNC_CENTER, DIK_E, 0);
    ...
    sithControl_MapFunc(INPUT_FUNC_PREVINV, DIK_K, 0);
    sithControl_MapFunc(INPUT_FUNC_NEXTINV, DIK_L, 0);
    sithControl_MapFunc(INPUT_FUNC_USEINV, DIK_LMENU, 0);
    sithControl_MapFunc(INPUT_FUNC_PREVSKILL, DIK_O, 0);
    sithControl_MapFunc(INPUT_FUNC_NEXTSKILL, DIK_P, 0);
    sithControl_MapFunc(INPUT_FUNC_USESKILL, DIK_PRIOR, 0);
    sithControl_MapFunc(INPUT_FUNC_PREVWEAPON, DIK_DELETE, 0);
    sithControl_MapFunc(INPUT_FUNC_NEXTWEAPON, DIK_INSERT, 0);
...
void sithControl_MapDefaultsJoystick() {
    ...
    /*
     * Pyra: do not bind the gamepad hat to inventory/Force selection.
     *
     * The Pyra D-pad/arrow controls can be reported both as keyboard arrows
     * and as the SDL gamepad hat. Keeping these mappings would therefore
     * trigger inventory/Force selection while the same keys move the player.
     */
